      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                {/* Added DigitalOcean section */}
                <div className="flex items-center mt-4 mb-4">
                  <p className="text-sm text-gray-600 dark:text-gray-400 mr-2">Powered by</p>
                  <a href="https://www.digitalocean.com/" target="_blank" rel="noopener noreferrer" className="flex items-center">
                    <Image
                      width={120}
                      height={24}
                ...
                <p className="mb-10 mt-5">
                  Developing websites, apps, and enterprise systems including ERP, POS, and CRM tailored to your needs.
                </p>
                ...
                <a
                  href="mailto:contact@vertex-software-enterprise.com"
                  className="text-itemtitle font-medium text-black dark:text-white block"
                >
                  contact@vertex-software-enterprise.com
                </a>
                <a
                  href="tel:+94775206659"
                  className="text-itemtitle font-medium text-black dark:text-white mt-2 block"
                >
                  +94 77 520 6659
                </a>
              </motion.div>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Vertex Software Enterprise. All rights reserved
              </p>
            </motion.div>
